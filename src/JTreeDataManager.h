...
class JTreeDataManager  {
	...
	public:
        ...
        void SetParticleCuts(double lCutEta, double lCutPt){ fManagerParticleEtaCut = lCutEta;
                                                             fManagerParticlePtCut  = lCutPt; };
		void ChainInputStream(const char* infileList);
		int LoadEvent( int ievt );
		virtual void RegisterList(TClonesArray* listToFill);
	...
	protected:
        ...
        double fManagerParticleEtaCut;
        double fManagerParticlePtCut;
};
